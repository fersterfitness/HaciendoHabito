    ...
    <div>
      ...
      <div className="px-4 lg:px-6 py-6 w-full">
        <p className="text-sm text-ink-secondary mb-6 leading-relaxed">
          ...
          <Link to="/routines/new" className="text-brand-primary font-medium hover:underline">crear una rutina nueva</Link>, elegí una entrada del{' '}
          <strong className="text-ink-primary">diccionario</strong> para copiar bloques, días y ejercicios.
        </p>
